...
dataset_name = "drugbankCheckerAllValue/"
...
for key, value in drug_dict_new.items():
...
for i in range(len(test_data)):
    ...
    text = f"The solvation Gibbs free energy of these two molecules is {random.random()}."
